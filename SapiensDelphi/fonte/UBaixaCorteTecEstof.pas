...
type
  TFBaixaCorteTecEstof = class(TForm)
    dbg1: TDBGrid;
    dsClientBaixaCorteTecEstof: TDataSource;
    edtNumAne: TEdit;
    edtProduto: TEdit;
    edtQtdPed: TEdit;
    edtQtdPro: TEdit;
...
var
  FBaixaCorteTecEstof: TFBaixaCorteTecEstof;

implementation

uses UDmOra, UDm1, UDm2, UThreadBaixaTecEstof;

{$R *.dfm}

procedure TFBaixaCorteTecEstof.btn1Click(Sender: TObject);
begin
   Dm1.ClientBaixaCorteTecEstof.First;
   Dm1.ClientBaixaCorteTecEstof.Open;
   while not Dm1.ClientBaixaCorteTecEstof.Eof do
     begin
           Dm1.ClientBaixaCorteTecEstof.Edit;
...
procedure TFBaixaCorteTecEstof.btn2Click(Sender: TObject);
begin
     ...
     while not Dm1.ClientBaixaCorteTecEstof.Eof do
       begin
             ...
             if Dm1.ClientBaixaCorteTecEstofQTDMOV.Value > 0 then
                Dm1.ClientBaixaCorteTecEstofITESEL.Value := 'S'
             else
                Dm1.ClientBaixaCorteTecEstofITESEL.Value := 'N';
             Dm1.ClientBaixaCorteTecEstof.Post;
...
if vaComando = 'ESTORNO' then
   begin
     ...
     while not Dm1.ClientBaixaCorteTecEstof.Eof do
       begin
             Dm1.ClientBaixaCorteTecEstof.Edit;
             if Dm1.ClientBaixaCorteTecEstofQTDPRO.Value > 0 then
                Dm1.ClientBaixaCorteTecEstofITESEL.Value := 'S'
             else
                Dm1.ClientBaixaCorteTecEstofITESEL.Value := 'N';
             Dm1.ClientBaixaCorteTecEstof.Post;
...
procedure TFBaixaCorteTecEstof.btnConfirmarClick(Sender: TObject);
var vnQtdTec : Double;
...
procedure TFBaixaCorteTecEstof.dbg1CellClick(Column: TColumn);
begin
  if (dbg1.SelectedField.FieldName = 'IMAGEM') and (Dm1.ClientBaixaCorteTecEstofQTDMOV.Value > 0) and (vaComando = 'BAIXA') then
     begin
       Dm1.ClientBaixaCorteTecEstof.Open;
       Dm1.ClientBaixaCorteTecEstof.Edit;

         if Dm1.ClientBaixaCorteTecEstofITESEL.Value = 'N' then
            Dm1.ClientBaixaCorteTecEstofITESEL.Value := 'S'
         else
         if Dm1.ClientBaixaCorteTecEstofITESEL.Value = 'S' then
            Dm1.ClientBaixaCorteTecEstofITESEL.Value := 'N';
     ...
     if (dbg1.SelectedField.FieldName = 'IMAGEM') and (Dm1.ClientBaixaCorteTecEstofQTDPRO.Value > 0) and (vaComando = 'ESTORNO') then
        begin
           Dm1.ClientBaixaCorteTecEstof.Open;
           Dm1.ClientBaixaCorteTecEstof.Edit;
...
procedure TFBaixaCorteTecEstof.dbg1DrawColumnCell(Sender: TObject;
  ...
  if Column.FieldName = 'IMAGEM' then
     begin//1
       ...
       if Dm1.ClientBaixaCorteTecEstofITESEL.Value = 'S' then
          ...
          DrawFrameControl(dbg1.Canvas.Handle,R,DFC_BUTTON, DFCS_BUTTONCHECK or Check);
     end;//1

end;

procedure TFBaixaCorteTecEstof.FormShow(Sender: TObject);
begin
  {if vaComando = 'ESTORNO' then
     begin
       Dm1.ClientBaixaCorteTecEstofQTDMOV.ReadOnly := True;
     end
  else
     begin
       Dm1.ClientBaixaCorteTecEstofQTDMOV.ReadOnly := false;
     end; }
end;
