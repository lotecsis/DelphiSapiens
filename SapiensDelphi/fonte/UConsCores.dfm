object FConsCores: TFConsCores
  ...
  object EdPesquisa: TCurrencyEdit
    Left = 8
    Top = 16
    Width = 153
    Height = 21
  ...
  object DsConsUsu_TDerCor: TDataSource
    AutoEdit = False
    DataSet = Dm2.ConsUsu_TDerCor
    Left = 56
    Top = 168
  end
end
