...
type
  TFConsSimpPJuridica = class(TForm)
...
var
  FConsSimpPJuridica: TFConsSimpPJuridica;
   c : string;
implementation
...
procedure TFConsSimpPJuridica.FiltroPesquisaClick(Sender: TObject);
begin
EdPesquisa.Clear;
...
procedure TFConsSimpPJuridica.EdPesquisaKeyPress(Sender: TObject;
  var Key: Char);
begin
if FiltroPesquisa.ItemIndex = 1 then
  begin
...
procedure TFConsSimpPJuridica.EdPesquisaExit(Sender: TObject);
begin
BPesquisa.Click;
end;

procedure TFConsSimpPJuridica.BPesquisaClick(Sender: TObject);
begin
//c := 'C';
...
procedure TFConsSimpPJuridica.FormKeyPress(Sender: TObject; var Key: Char);
begin
if key = #13 then
    begin
      key := #0;
...
procedure TFConsSimpPJuridica.BCancelarClick(Sender: TObject);
begin
Close;
end;

procedure TFConsSimpPJuridica.FormShow(Sender: TObject);
begin
