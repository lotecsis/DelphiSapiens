object FNivelAcesso: TFNivelAcesso
  ...
  Caption = 'Cadastro de N'#237'vel de Acesso'
  Color = clBtnFace
  ...
  object DSNivel: TDataSource
    AutoEdit = False
    DataSet = Dm.CadUsu_TNivAce
    OnStateChange = DSNivelStateChange
    Left = 256
    Top = 152
  end
  object DSGrid: TDataSource
    DataSet = Dm.ConsUsu_TNivAce
    Left = 332
    Top = 128
  end
end
