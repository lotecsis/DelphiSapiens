...
type
  TFPrincipal = class(TForm)
    ...
    mnufrmCadRepresentante_Cidades: TMenuItem;
    ...
    procedure mnufrmCadRepresentante_CidadesClick(Sender: TObject);
  private
...
procedure TFPrincipal.mnufrmCadRepresentante_CidadesClick(Sender: TObject);
begin
