object FUsuario: TFUsuario
  ...
  object PaginaControle: TPageControl
    ...
    object TbManutencao: TTabSheet
      ...
      object Label6: TLabel
        ...
        FocusControl = DBENivAce
      end
      object BConsNivAce: TSpeedButton
        Left = 159
        Top = 189
        Width = 23
        Height = 20
        OnClick = BConsNivAceClick
      end
      object LDsNivAce: TLabel
        Left = 192
        Top = 194
        Width = 3
        Height = 13
      ...
      object DBESenUsu: TDBEdit
        Left = 77
        Top = 118
        Width = 161
        Height = 21
        DataField = 'USU_SENUSU'
        DataSource = DsManutencao
        PasswordChar = '*'
        TabOrder = 2
      end
      object DBELogUsu: TDBEdit
        ...
        Height = 21
        CharCase = ecUpperCase
        DataField = 'USU_LOGUSU'
        DataSource = DsManutencao
        MaxLength = 100
        TabOrder = 1
      end
      object DBENivAce: TDBEdit
        Left = 77
        Top = 189
        Width = 81
        Height = 21
        ...
        DataSource = DsManutencao
        TabOrder = 4
        OnExit = DBENivAceExit
      end
      object CbSitUsu: TComboBox
        Left = 77
        Top = 153
        Width = 81
        Height = 22
  ...
  object DSGrid: TDataSource
    DataSet = Dm.ConsUsu_TR999Usu
    Left = 404
    Top = 65528
  end
  object DsImportacao: TDataSource
    AutoEdit = False
    DataSet = Dm.Client_R999Usu
    Left = 360
  end
  object DsManutencao: TDataSource
    DataSet = Dm.CadUsu_TR999Usu
